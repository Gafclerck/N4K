    ...
    <div class="flex-1 overflow-y-auto scrollbar-none px-3 py-4" style="scrollbar-width:none;">
      ...
      <div>
        ...
        <div class="space-y-0.5">
          ...
          <a href="groupes.php" class="w-full flex items-center gap-2.5 px-2 py-1.5 rounded-md text-left transition-colors duration-150 sidebar-hover-bg" style="font-size:14px;color:#cfc3cf;"
