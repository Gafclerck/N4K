<?php
//  cette page sera si incluse dans une pagee ou la variable $showCreateModal est définie à true. Sinon, elle ne fera rien.
        ...
        <form action="/groupes/create" method="POST" class="px-5 py-4 space-y-4">
            ...
            <div>
                ...
                <textarea name="description" rows="3" placeholder="Décrivez l'objectif du groupe…"
                    ...
                    style="font-size:15px;"><?php echo htmlspecialchars($olds['description'] ?? ''); ?></textarea>
