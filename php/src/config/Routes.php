...
$router->post("/favoris/toggle", 'UserController@toggleFavori');
...
$router->get("/ressource/{id}", 'RessourceController@detail');
$router->post("/ressource/{id}/commenter", 'RessourceController@commenter');
